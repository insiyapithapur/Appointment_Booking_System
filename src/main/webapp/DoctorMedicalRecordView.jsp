...
<body>
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="${pageContext.request.contextPath}/Doctor/Dashboard" class="btn btn-outline-primary">
                ...
                <div class="medical-record-section">
                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="metadata">Patient: ${medicalRecord.appointment.patient.user.username}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="actions">
            ...
            <button class="btn btn-success" onclick="editRecord(${appointmentId})" style="background-color: #61CE70; border-color: #61CE70;">
