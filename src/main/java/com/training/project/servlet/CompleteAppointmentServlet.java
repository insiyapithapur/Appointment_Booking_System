...
@WebServlet("/Doctor/CompleteAppointment")
public class CompleteAppointmentServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        super.init();
        System.out.println("Complete Appointment servlet initialized");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (appointmentIdStr != null && !appointmentIdStr.isEmpty()) {
            try {
                ...
                request.getRequestDispatcher("/CompleteAppointment.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (appointmentIdStr == null || appointmentIdStr.isEmpty() ||
            ...
            response.sendRedirect(request.getContextPath() + "/Doctor/CompleteAppointment?appointmentId=" + appointmentIdStr);
            return;
        }
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/Doctor/Appointment");
